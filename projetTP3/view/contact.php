<?php
session_start();
require("C://wamp64/www/projetTP3/controller/controller.php");
if (isset($_POST['submit-contact'])) {
    ...
    if (empty($name)) {
        ...
        try {
            ...
            if ($flag === true) {
                $registerMsg = "Merci " . $name . " nous vous repondrons sous peu à " . $email;
            } else {
...
?>
<div class="contact">
    <div class="adresse position left">
        <h2>Adresse</h2>
    ...
    <div class="adresse position right">
        <h2>Carte</h2>
        <div id="map"></div>
    </div>
</div>
<?php $page_url = "/wamp64/www/projetTP3/view/contact.php"; ?>
